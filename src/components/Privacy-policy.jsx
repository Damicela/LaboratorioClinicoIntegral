const PrivacyPolicy = () => {
  return (
    <div className="container py-10 px-20">
      <h1 className="uppercase text-center text-2xl font-bold text-gray-800">política de privacidad</h1>
      <br />
      <p className="text-justify text-lg">
        La presente Política de Privacidad establece los términos en que
        Laboratorio Clínico Integral usa y protege la información que es
        proporcionada por sus usuarios al momento de utilizar su sitio web. E
        sta compañía está comprometida con la seguridad de los datos de sus
      ...
      <br />
      <p className="text-justify text-lg">
        Información que es recogida Nuestro sitio web podrá recoger información
        personal por ejemplo: Nombre, información de contacto como su dirección
      ...
      <br />
      <p className="text-justify text-lg">
        Uso de la información recogida Nuestro sitio web emplea la información
        con el fin de proporcionar el mejor servicio posible, particularmente
        para mantener un registro de usuarios, de pedidos en caso que aplique, y
        mejorar nuestros productos y servicios. Es posible que sean enviados
      ...
      <br />
      <p className="text-justify text-lg">
        Laboratorio Clínico Integral está altamente comprometido para cumplir
        con el compromiso de mantener su información segura. Usamos los sistemas
        más avanzados y los actualizamos constantemente para asegurarnos que no
        exista ningún acceso no autorizado. <br />
        Cookies <br />
        ...
        servicio personalizado de su web. <br />
        ...
        que usted está de acuerdo con estas. <br />
        ...
        Laboratorio Clínico Integral Se reserva el derecho de cambiar los
